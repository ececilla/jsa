 ...
 */
exports.start_expire_timer = function( timer, ret_handler ){
	
	
	var interval = timer.etime - new Date().getTime();
	
	if(interval > 0) 
		setTimeout( function(){
												
				db.remove_expired(timer.catalog, timer.wid, function(err,n){
 ...
 * Load timers from db.
 */
exports.load_expire_timers = function(){
