...
exports.execute = function( proc_name, params, ret_handler){
	...
	function(next_phase){ //incoming plugins		
	...
	function(next_phase){ //constraints pre objects load
	...
	function(next_phase){ //constraints post objects load						
	...
	function(next_phase){ //execute outgoing plugins
