...
/*
 * Hook a constraint to the remote procedure to be called after the document load
 */
exports.add_constraint_post =  function( proc_name, cons_name, func_handler ){
	
	if(!constraints.post[proc_name])
		constraints.post[proc_name] = {};
	...
	constraints.post[proc_name][cons_name] = function(params, doc){
...
/*
 * Hook  constraint to the remote procedure to be called before the document load.
 */
exports.add_constraint_pre =  function( proc_name, cons_name, func_handler ){
	
	if(!constraints.pre[proc_name])
		constraints.pre[proc_name] = {};
	...
	constraints.pre[proc_name][cons_name] = function(params, doc){
...
exports.execute = function( proc_name, params, ret_handler){
	...
	load_document(params, function(err,doc){//document load
		...
		if(err)
			...
			//No constraint satisfied, so execute procedure.				
