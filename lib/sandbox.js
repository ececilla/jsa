...
/*
 * Add a plugin for incoming or outcoming phase step. 
 */
...
exports.execute = function( proc_name, params, ret_handler){
	...
	*/
	...
	async.forEachSeries(Object.keys(plugins[ctx.params.catalog] && plugins[ctx.params.catalog]._in[proc_name]||{}),function(plugin_name,next){
		...
		plugins[ctx.params.catalog]._in[proc_name][plugin_name](ctx, function(){
			...
			if(err){
				...
				api.remote[proc_name](ctx, function(err,val){
					...
					function(next){//execute plugouts: may modify ctx.doc, ctx.retval and ctx.payload
						...
						async.forEachSeries(Object.keys(plugins[ctx.params.catalog] && plugins[ctx.params.catalog]._out[proc_name]||{}),function(plugout_name,end_handler){
							
							plugins[ctx.params.catalog]._out[proc_name][plugout_name](ctx, end_handler);
