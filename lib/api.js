...
exports.remote = {
	...
	/*
	 * Remove a field from the document.TODO: change to mongodb $unset
	 */
	...
	/*
	 * Set a value to the field or create it if not exists.TODO:transform operation to $set
	 */
	set: function( ctx, ret_handler){
		
		var update_criteria = {$set:{}};
		update_criteria.$set[ctx.params.fname] = ctx.params.value;	
		
		db.update( ctx.params.catalog, ctx.params.wid, update_criteria ,function(err){
	...
	push: function(ctx, ret_handler){
		...
		var update_criteria = {$push:{}};
		update_criteria.$push[ctx.params.fname] = ctx.params.value;	
	...
	pop: function(ctx, ret_handler){
		...
		var update_criteria = {$pop:{}};
		update_criteria.$pop[ctx.params.fname] = 1;	
