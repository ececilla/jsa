...
var _chandlers = [
	...
	function( params ){
		...
		var is_notifiable = params.catalog == "docs" || params.notifiable;
		delete params.notifiable;		
	...
	async.series([
		function(next){
			...
			if(params.doc.rcpts && exports.rcpts){
				...
				exports.rcpts( params.doc, {select:db.select, criteria:db.criteria}, function(rcpts){
