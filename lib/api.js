 ...
 */	
/*
exports.initrcpts = function( params ){
...
/*
 * default musteventize decision function
 */
var _eventizehandlers = [
...
function musteventize( params ){
	
	for (i in _eventizehandlers){
		if( _eventizehandlers[i](params) )
			return true;
	}	
}


exports.init.addeventizehandler = function( eventize_handler ){
	
	_eventizehandlers.unshift(eventize_handler);
}
...
exports.remote.create = function( params, ret_handler ){
	...
	if( musteventize(params) )
		params.doc.rcpts = [params.uid];
	
	async.series([
		function(next){
			 
			if(params.doc.rcpts && exports.initrcpts){
