...
/*
 * Helper function to return mongodb native driver collection object or create it if not exists.
 */
			...
			if( typeof params.dbuser !== "undefined" && typeof params.dbpass !== "undefined" ){
				...
				db.authenticate(params.dbuser,params.dbpass,function(err,client){
					...
					if(client){
						...
						db.ensure_collection = ensure_collection;
						if(ret_handler)
							ret_handler(null,1);						
					}else{
...
var save = exports.save = function( col_name, obj, ret_handler ){
	...
	db.ensure_collection(col_name, function(err, collection){
...
/*
 * Remove expired object and its events.
 */
/*
 *  Function to remove a document from db and also its related events.
 */
var remove_expired = exports.remove_expired = function( col_name, id_str, ret_handler ){
