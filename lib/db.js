...
exports.connect = function( params, ret_handler ){
	...
	db = new mongo.Db(params.dbname, new mongo.Server(params.dbhost,params.dbport,{auto_reconnect:true, socketOptions:{timeout:5000}}),{strict:true, safe:true}); //,poolSize:5,socketOptions:{timeout:1}
			...
			async.series([
				function(next){
					...
					async.forEach(rcpts, function(rcpt,next){
						...
						criteria("users",{uid:rcpt},{},function(err,users){
