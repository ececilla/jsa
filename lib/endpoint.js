...
function process(jsonrpc_req_str, ret_handler){
    ...
    if( !api.remote[jsonrpc_req.method] || !srv.api.config.primitives[jsonrpc_req.method] ){
    ...
    sandbox.execute(jsonrpc_req.method, jsonrpc_req.params, function(err,result){
