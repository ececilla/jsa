 ...
 */
exports.execute_plugins = function(proc_name, ctx, ret_handler){
	
	async.forEachSeries(Object.keys(plugins[proc_name]||{}),function(plugin_name,next){
		
		plugins[proc_name][plugin_name](ctx, next);							
	},function(){
...
function process(jsonrpc_req_str, ret_handler){
    ...
    sandbox.execute(jsonrpc_req.method, jsonrpc_req.params, function(err,ctx){
		...
		exports.execute_plugins(jsonrpc_req.method, ctx, function(ctx){
