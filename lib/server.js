...
/*
 * make remote api functions public to front module, so can call them from code:
 * var jsa = require("jsa");
 * jsa.api.create({uid:32342,doc:{test:1}},function(err,ret_val){ ... })
 */
var api = require("./api");
exports.api = {};
for( key in api.remote ){
	
	exports.api[key] = function(params, ret_handler){
		
		api.remote[key](params, ret_handler);
	}
