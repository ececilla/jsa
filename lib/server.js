...
srv.init.execute = [
	...
	function( end_handler ){
		...
		sandbox.add_constraint_pre("create","param_uid",sandbox.constraints.is_required("uid"))//create constraints.
	   		   ...
	   		   .add_constraint_pre("create","writable_catalog",sandbox.constraints.writable_catalog)
	  		   ...
	  		   .add_constraint_pre("dispose","param_uid",sandbox.constraints.is_required("uid"))
	   		   ...
	   		   .add_constraint_pre("dispose","writable_catalog",sandbox.constraints.writable_catalog)
	   		   ...
	   		   .add_constraint_pre("join","writable_catalog",sandbox.constraints.writable_catalog)
	   		   ...
	   		   .add_constraint_pre("unjoin","writable_catalog",sandbox.constraints.writable_catalog)
	   		   ...
	   		   .add_constraint_pre("remove","writable_catalog",sandbox.constraints.writable_catalog)
	   		   ...
	   		   .add_constraint_post("set","user_catalog",sandbox.constraints.user_catalog)//set constraints
	   		   .add_constraint_pre("set","writable_catalog",sandbox.constraints.writable_catalog)
	   		   ...
	   		   .add_constraint_post("push","user_catalog",sandbox.constraints.user_catalog)//push constraints
	   		   .add_constraint_pre("push","writable_catalog",sandbox.constraints.writable_catalog)
	   		   ...
	   		   .add_constraint_post("push","has_joined",sandbox.constraints.field_type("array"))
	   		   .add_constraint_pre("pop","user_catalog",sandbox.constraints.user_catalog)//pop constraints
	   		   .add_constraint_pre("pop","writable_catalog",sandbox.constraints.writable_catalog)
	   		   ...
	   		   .add_constraint_pre("shift","writable_catalog",sandbox.constraints.writable_catalog)
	   		   ...
	   		   .add_constraint_pre("get","user_catalog",sandbox.constraints.user_catalog)//get constraints
	   		   .add_constraint_pre("get","writable_catalog",sandbox.constraints.writable_catalog)
