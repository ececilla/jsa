...
var system = {pid:process.pid, uid:process.getuid(), cwd:process.cwd(), node_version:process.version };
...
exports.start = function( econfig, ret_handler ){
	...
	util.change_console_log_printing_format();
