...
for( key in api.remote ){
	...
	(function(){
		...
		var scopekey = key;		
		srv.config.runtime.api[scopekey] = CONST.ENABLE();
...
for( key in api.config ){
	...
	(function(){
		var scopekey = key;
		exports.api.config[scopekey] = function(params, ret_handler){
...
srv.api.config.newop = function( fname, f_handler ){ 
	...
	srv.config.runtime.api[fname] = 1;
