...
var init_arr = [
	...
	function( end_handler ){
		...
		sandbox.add_constraint_pre("get","user_catalog",sandbox.constraints.user_catalog,"users")
	   	...
	   	//sandbox plugins and plugouts.
	   	sandbox.add_plugin("create","notifying_doc",sandbox.plugins.notifying_doc)
	   		   ...
	   		   .add_plugout("get","rewrite_id",sandbox.plugins.rewrite_id);	   
