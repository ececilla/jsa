...
exports["api.remote.join: valid params, default catalog, no rcpts"] = function(test){
	
		
	var dbdocs = {};//documents at db
		dbdocs["50187f71556efcbb25000001"] = {_id:"50187f71556efcbb25000001", uid:620793115, a:1, b:"test1234", rcpts:[], catalog:"docs"};
	...
	async.series(
		[function(next){
			...
			sb.execute("join", params, function(err,ctx){
				...
				test.ok(flag);				
				test.equal(err,null);		
				test.deepEqual(ctx.retval.rcpts, [{uid:"620793114", push_id:"gcm-114",push_type:"gcm"}]);
...
exports["api.remote.join: valid params, default catalog, no rcpts, ev_types:[]"] = function(test){
	...
	var sb = sandbox.require("../lib/sandbox",{
		requires:{"./db":{
							...
							save:function(col_str,doc,ret_handler){
								...
								if(col_str == "docs"){								
									test.equal(col_str,"docs");
									test.deepEqual(doc.rcpts, [{uid:"620793114",push_id:"gcm-114",push_type:"gcm",ev_types:["ev_api_set","ev_api_create"]}]);									
	...
	sb.execute("join", params, function(err,ctx){
		...
		test.ok(flag);				
		test.equal(err,null);		
		test.deepEqual(ctx.retval.rcpts, [{uid:"620793114", push_id:"gcm-114",push_type:"gcm",ev_types:["ev_api_set","ev_api_create"]}]);
		test.equal(ctx.retval._id, undefined);		
		test.equal(ctx.retval.wid, "50187f71556efcbb25000001");
		test.equal(ctx.retval.catalog, "docs");		
		test.equal(ctx.retval.a,1);
...
exports["api.remote.join: valid params, default catalog, no rcpts, ev_types.$push:[]"] = function(test){
	...
	var params = {uid:620793114, wid:"50187f71556efcbb25000001", ev_types:{$push:["ev_api_set","ev_api_create"]}};//uid not in rcpts
...
exports["api.remote.join: valid params, default catalog, no rcpts, ev_types.$set:[]"] = function(test){
	...
	var params = {uid:620793114, wid:"50187f71556efcbb25000001", ev_types:{$set:["ev_api_set","ev_api_create"]}};//uid not in rcpts
...
exports["api.remote.join: valid params, default catalog, rcpts, no ev_types"] = function(test){
...
exports["api.remote.join: valid params, default catalog, rcpts, ev_types:[]"] = function(test){
...
exports["api.remote.join: valid params, default catalog, rcpts, ev_types.$push:[]"] = function(test){
	...
	async.series(
		[function(next){
			...
			params = {uid:620793114, wid:"50187f71556efcbb25000001", ev_types:{$push:["ev_api_dispose"]}};//uid not in rcpts
...
exports["api.remote.join: valid params, default catalog, rcpts, ev_types.$pop:i"] = function(test){
	...
	async.series(
		...
		function(next){
			params = {uid:620793114, wid:"50187f71556efcbb25000001", ev_types:{$pop:1}};//uid not in rcpts
						
			sb.execute("join", params, function(err,ctx){
																	
				test.equal(err,null);	
				test.equal(ctx.retval,1);	
				test.deepEqual(ctx.doc.rcpts, [{uid:"620793115", push_id:"gcm-115", push_type:"gcm"},{uid:"620793117", push_id:"gcm-117", push_type:"gcm"},{uid:"620793114", push_id:"gcm-114",push_type:"gcm",ev_types:["ev_api_set","ev_api_create"]}]);
		...
		function(next){
			params = {uid:620793114, wid:"50187f71556efcbb25000001", ev_types:{$pop:2}};//uid not in rcpts
...
exports["api.remote.join: valid params, default catalog, rcpts, ev_types.$set:[]"] = function(test){
	...
	async.series(
		[function(next){
			...
			params = {uid:620793114, wid:"50187f71556efcbb25000001", ev_types:{$set:["ev_api_dispose"]}};//uid not in rcpts
...
exports["api.remote.join: valid params, default catalog, rcpts, ev_types.$remove:[]"] = function(test){
	...
	async.series(
		[function(next){
			...
			params = {uid:620793114, wid:"50187f71556efcbb25000001", ev_types:{$remove:["ev_api_set"]}};//uid not in rcpts
